...
public:
    ...
    {
        if (a.Burst.front().second < b.Burst.front().second)
            return false;

        if (a.Burst.front().second == b.Burst.front().second && a.pid < b.pid)
        {
            return false;
        }
        return true;
...
public:
    SJF(int numOfProcess, int quantumValue)
    {
...
int main()
{
    ...
    SJF sjf(numOfProcess, quantumValue);
